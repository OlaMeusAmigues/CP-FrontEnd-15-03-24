    ...
    if (valores_nulos != 0) {
        ...
        <div id="dados_usuario">
            ...
            <div id="usuario_texto">
                <div id="usuario_nome">
                    <strong>${lista_ids[0].value}</strong>
                </div>
                <div id="usuario_local">${lista_ids[2].value}, ${lista_ids[3].value}</div>
            </div>
        </div>
...
const atualizar_comentarios = () => {
    if (!(localStorage.getItem('nomes'))) { }
        ...
        <div id="dados_usuario">
            ...
            <div id="usuario_texto">
                <div id="usuario_nome">
                    <strong>${nova_classe.nome}</strong>
                </div>
                <div id="usuario_local">${nova_classe.lugar_Es}, ${nova_classe.lugar_Pa}</div>
            </div>
        </div>
    <div id="estrelas_data">
        <div id="estrelas" class="ponto">
